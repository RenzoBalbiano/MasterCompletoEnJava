...
public class PasarPorValor {
    ...
    public static void main(String[] args) {
        ...
        test(i); //invocamos el método. /7 se pasó el valor y no la referencia. Por eso se mantiene en 10.
        ...
        // esto se debe a que ciertas clases de java, entre ellas Integer son inmutables. Lo que retorna es una nueva instancia, en el caso del 35.
