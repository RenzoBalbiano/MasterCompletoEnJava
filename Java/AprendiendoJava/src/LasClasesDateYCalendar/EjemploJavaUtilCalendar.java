...
public class EjemploJavaUtilCalendar {
    ...
    public static void main(String[] args) {
        ...
        // la instancia la maneja la propia clase por debajo con getInstance. Que es un
        // método estático. Se encarga de crear el objeto.
        ...
        SimpleDateFormat df9 = new SimpleDateFormat("yyyy-MM-dd 'T' hh:mm:ss.SSSXXX a"); // con HH adopta formato 24
                                                                                         // horas. con hh formato 12
                                                                                         // horas.
