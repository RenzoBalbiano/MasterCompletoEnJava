...
public class EjemploJavaUtilDateParse {
  ...
  /*       SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd"); // la fecha que ingresemos debe tener el patrón
                                                                      // que configuremos acá.
        try {
            Date fecha = format.parse("2020-12-25");
