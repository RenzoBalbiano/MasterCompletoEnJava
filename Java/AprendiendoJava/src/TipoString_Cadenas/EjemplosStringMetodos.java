...
public class EjemplosStringMetodos {
    public static void main(String[] args) {
        ...
        System.out.println(trabalenguas.indexOf("z"));// retorna -1, porque no está.Por eso para validar podemos decir
                                                      // que el index sea == o mayor a 0.
        System.out.println(trabalenguas.indexOf("lenguas"));// retorna -1, porque no está.Por eso para validar podemos
                                                            // decir que el index sea == o mayor a 0.
